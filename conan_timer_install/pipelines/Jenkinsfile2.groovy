 node("master") {
        ...
        def conanClient = Artifactory.newConanClient userHome: "/Users/jingyil"
        ...
        conanClient.run(command: "install ./conan_timer_install_withbuild_binary/ --build missing", buildInfo: buildInfo)
